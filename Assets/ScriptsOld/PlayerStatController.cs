...
namespace  VampireSLike
{
    public class PlayerStatController : MonoBehaviour
    {
        ...
        public void PurchaseMoveSpeed()
        {
            ...
            BattleManager.Instance.PlayerCtrl.moveSpeed = moveSpeed[moveSpeedLevel].value;
        }
        ...
        public void PurchasePickupRange()
        {
            ...
            BattleManager.Instance.PlayerCtrl.pickupRange = pickupRange[pickupRangeLevel].value;
        }
        ...
        public void PurchaseMaxWeapons()
        {
            ...
            BattleManager.Instance.PlayerCtrl.maxWeapons = Mathf.RoundToInt(maxWeapons[maxWeaponsLevel].value);
        }
    }
