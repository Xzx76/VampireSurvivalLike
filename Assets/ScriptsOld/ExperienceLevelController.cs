...
namespace VampireSLike
{
    public class ExperienceLevelController : MonoBehaviour
    {
        ...
        void LevelUp()
        {
            ...
            availableWeapons.AddRange(BattleManager.Instance.PlayerCtrl.assignedWeapons);
            ...
            if (BattleManager.Instance.PlayerCtrl.assignedWeapons.Count + BattleManager.Instance.PlayerCtrl.fullyLevelledWeapons.Count < BattleManager.Instance.PlayerCtrl.maxWeapons)
            {
                availableWeapons.AddRange(BattleManager.Instance.PlayerCtrl.unassignedWeapons);
            }
